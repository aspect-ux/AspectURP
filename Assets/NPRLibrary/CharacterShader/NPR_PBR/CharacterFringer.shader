Shader "Character/LitFringe"
{
    ...
    SubShader
    {
		...
		Pass
        {
			...
			// -------------------------------------
            // Shader Stages
            #pragma vertex universalToonVert
           ...
           /* #pragma instancing_options renderinglayer
			...
			#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/UnityGBuffer.hlsl"
			#include "Packages/com.unity.render-pipelines.universal/ShaderLibrary/universalToon.hlsl"
...
//            #pragma instancing_options renderinglayer
    ...
    //CustomEditor "UnityEditor.universalGUI.universalGUI"
