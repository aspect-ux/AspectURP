...
public class PixelizeRendererFeature : ScriptableRendererFeature
{
    ...
    class PixelizeRenderPass : ScriptableRenderPass
    {
        ...
        public PixelizeRenderPass(ComputeShader filterComputeShader, string kernelName, int blockSize, int renderTargetId)
        {
    ...
    public override void Create()
    {
        ...
        m_ScriptablePass = new PixelizeRenderPass(FilterComputeShader, KernelName, BlockSize, renderTargetId);
