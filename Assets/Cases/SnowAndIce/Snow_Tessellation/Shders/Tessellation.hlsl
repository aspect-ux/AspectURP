...
// 3. 曲面细分部分参考：https://zhuanlan.zhihu.com/p/359999755
...
[UNITY_domain("tri")] // 定义特性，表示输入Hull shader的图元为Triangle
[UNITY_outputcontrolpoints(3)] // 三个控制点
[UNITY_outputtopology("triangle_cw")] // 图元朝向,顺时针环绕
